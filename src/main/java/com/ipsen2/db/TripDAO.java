...
public interface TripDAO {
     ...
     */
    //werkt
    @SqlUpdate("insert into trip (user_id, start_cords, end_cords, distance, license_plate, project_id) values (:userId, :startCords, :endCords, :distance, :licensePlate, :projectId)")
